...
const resources = {
  ...
  ru: {
    translation: {
      ...
      aboutMeTxt: `Люди зовут меня Мухой, мне 17 лет, я занимаюсь разработкой веб-приложений и получаю от этого удовольствие. Пока что хочу стать профессионалом в этой области. 
